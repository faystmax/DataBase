...
public class StatusAddUpdate extends javax.swing.JFrame {
    ...
    public StatusAddUpdate(int addOrUpdate, int PK) {
        ...
        if (addOrUpdate == 1) {
            ...
            try {
                resSet = MainRemOtdel.st.executeQuery("select nameofstatus from status where status.PK_status=" + PK);
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    MainRemOtdel.st.executeQuery("Insert into SERVERADM.Status (NAMEOFSTATUS) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        MainRemOtdel.st.executeQuery("UPDATE SERVERADM.status SET NAMEOFSTATUS = '" + text + "' WHERE PK_Status=" + PK);
