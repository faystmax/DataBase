 ...
 * @author tigler
 */
public class Status extends javax.swing.JFrame implements UpdatesDataInForms {
    ...
    public void addDataInTable() {
        ...
        try {
            resSet = RemOtdel.st.executeQuery("select * from status");
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            try {
                ...
                if (option == 0) {
                    RemOtdel.st.executeQuery("delete from status where PK_status=" + PK);
                    addDataInTable();
                }
