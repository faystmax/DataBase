...
public class TypeCrashAddUpdate extends javax.swing.JFrame {
    ...
    public TypeCrashAddUpdate(int addOrUpdate, int PK) {
        ...
        try {
            resSet = MainRemOtdel.st.executeQuery("select nameofcrash from typeofcrash where PK_crash=" + PK);
        ...
        // TODO add your handling code here:
         if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    MainRemOtdel.st.executeQuery("Insert into SERVERADM.typeofcrash (NAMEOFcrash) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        MainRemOtdel.st.executeQuery("UPDATE SERVERADM.typeofcrash SET NAMEOFcrash = '" + text + "' WHERE PK_crash=" + PK);
