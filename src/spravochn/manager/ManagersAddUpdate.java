...
public class ManagersAddUpdate extends javax.swing.JFrame {
    ...
    public ManagersAddUpdate(int addOrUpdate, int PK) {
        ...
        if (addOrUpdate == 1) {
            ...
            try {
                resSet = MainRemOtdel.st.executeQuery("select nameofmanager,otcofmanager,famofmanager,login,password"
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                ...
                try {
                    MainRemOtdel.st.executeQuery("Insert into SERVERADM.manager (famofmanager,nameofmanager,otcofmanager,login,password) values "
            ...
            if (addOrUpdate == 1) {
                ...
                if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                    ...
                    try {
                        MainRemOtdel.st.executeQuery("UPDATE SERVERADM.manager SET famofmanager = '" + textFam + "', "
