...
public class OrderUpdate extends javax.swing.JFrame {
    ...
    public OrderUpdate(int addOrUpdate, int PK) {
        ...
        if (addOrUpdate == 1) {
            ...
            try {
                resSet = MainRemOtdel.st.executeQuery("select myorder.PK_ORDER,"
                        + "myorder.NUMOFORDER,"
            ...
            try {
                if (resSet.next()) {
                    ...
                    ResultSet resSet2 = MainRemOtdel.st.executeQuery("select * from status");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jDateChooserCreate, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (textNumber.equals("") || textCost.equals("") || pkStatus.equals("")) {
            ...
            try {
                MainRemOtdel.st.executeQuery("UPDATE SERVERADM.myorder SET "
