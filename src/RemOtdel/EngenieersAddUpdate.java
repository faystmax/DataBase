...
public class EngenieersAddUpdate extends javax.swing.JFrame {
    ...
    public EngenieersAddUpdate(int addOrUpdate, int PK) {
        ...
        if (addOrUpdate == 1) {
            ...
            try {
                resSet = RemOtdel.st.executeQuery("select nameofengineer,otchofengineer,famofengineer,login,password"
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                ...
                try {
                    RemOtdel.st.executeQuery("Insert into SERVERADM.engineer (famofengineer,nameofengineer,otchofengineer,login,password) values "
            ...
            if (addOrUpdate == 1) {
                ...
                if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                    ...
                    try {
                        RemOtdel.st.executeQuery("UPDATE SERVERADM.engineer SET famofengineer = '" + textFam + "', "
