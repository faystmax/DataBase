...
public class DetailAddUpdate extends javax.swing.JFrame {
    ...
    public DetailAddUpdate(int addOrUpdate, int PK) {
        ...
        try {
            resSet = MainRemOtdel.st.executeQuery("select nameofdetail from detail where PK_detail=" + PK);
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    MainRemOtdel.st.executeQuery("Insert into SERVERADM.detail (NAMEOFdetail) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        MainRemOtdel.st.executeQuery("UPDATE SERVERADM.detail SET NAMEOFdetail = '" + text + "' WHERE PK_detail=" + PK);
