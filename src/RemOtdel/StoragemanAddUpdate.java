...
public class StoragemanAddUpdate extends javax.swing.JFrame {
    ...
    public StoragemanAddUpdate(int addOrUpdate, int PK) {
        ...
        if (addOrUpdate == 1) {
            ...
            try {
                resSet = RemOtdel.st.executeQuery("select nameofstorekeeper,otcofstorekeeper,famofstorekeeper,login,password"
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                ...
                try {
                    RemOtdel.st.executeQuery("Insert into SERVERADM.storekeeper (famofstorekeeper,nameofstorekeeper,otcofstorekeeper,login,password) values "
            ...
            if (addOrUpdate == 1) {
                ...
                if (textLogin.equals("") || textPassword.equals("") || textFam.equals("")
                    ...
                    try {
                        RemOtdel.st.executeQuery("UPDATE SERVERADM.storekeeper SET famofstorekeeper = '" + textFam + "', "
