 ...
 * @author tigler
 */
public class TypeCrash extends javax.swing.JFrame implements UpdatesDataInForms {

    /**
     * Creates new form TypeCrash
     */
    public TypeCrash() {
        initComponents();
        addDataInTable();
    ...
    public void addDataInTable() {
        ...
        try {
            resSet = MainRemOtdel.st.executeQuery("select * from typeofcrash");
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            TypeCrashAddUpdate typeCrashAddUpdate = new TypeCrashAddUpdate(1, primKey);
            typeCrashAddUpdate.setListenerCloseForm(new ListenerCloseForm(this));
            typeCrashAddUpdate.setVisible(true);
            this.setEnabled(false);
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            try {
                ...
                if (option == 0) {
                    MainRemOtdel.st.executeQuery("delete from typeofcrash where PK_crash=" + PK);
                    addDataInTable();
                }
