 ...
 */
package spravochn.typeofdevice;
...
public class TypeDeviceAddUpdate extends javax.swing.JFrame {
    ...
    public TypeDeviceAddUpdate(int addOrUpdate, int PK) {
        ...
        try {
            resSet = MainRemOtdel.st.executeQuery("select nameoftype from typeofdevice where PK_typeofdevice=" + PK);
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    MainRemOtdel.st.executeQuery("Insert into SERVERADM.typeofdevice (NAMEOFtype) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        MainRemOtdel.st.executeQuery("UPDATE SERVERADM.typeofdevice SET NAMEOFtype = '" + text + "' WHERE PK_typeofdevice=" + PK);
