    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    RemOtdel.st.executeQuery("Insert into SERVERADM.Status (NAMEOFSTATUS) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        RemOtdel.st.executeQuery("UPDATE SERVERADM.status SET NAMEOFSTATUS = '" + text + "' WHERE PK_Status=" + PK);
