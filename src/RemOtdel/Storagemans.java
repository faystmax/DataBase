 ...
 * @author tigler
 */
public class Storagemans extends javax.swing.JFrame implements UpdatesDataInForms {

    /**
     * Creates new form Storagemans
     */
    public Storagemans() {
        initComponents();
        addDataInTable();
    ...
    public void addDataInTable() {
        ...
        try {
            resSet = RemOtdel.st.executeQuery("select * from storekeeper");
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            try {
                ...
                if (option == 0) {
                    RemOtdel.st.executeQuery("delete from storekeeper where PK_storekeeper=" + PK);
                    addDataInTable();
                }
