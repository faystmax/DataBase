...
public class ManufacturerAddUpdate extends javax.swing.JFrame {
    ...
    ManufacturerAddUpdate(int addOrUpdate, int PK) {
        ...
        try {
            resSet = RemOtdel.st.executeQuery("select nameofmanufacturer from manufacturer where PK_manufacturer=" + PK);
    ...
    private void jButtonAddUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddUpdateActionPerformed
        ...
        if (addOrUpdate == 0) {
            ...
            if (text.equals("")) {
                ...
                try {
                    RemOtdel.st.executeQuery("Insert into SERVERADM.manufacturer (NAMEOFmanufacturer) values ('" + text + "')");
            ...
            if (addOrUpdate == 1) {
                ...
                if (text.equals("")) {
                    ...
                    try {
                        RemOtdel.st.executeQuery("UPDATE SERVERADM.manufacturer SET NAMEOFmanufacturer = '" + text + "' WHERE PK_manufacturer=" + PK);
